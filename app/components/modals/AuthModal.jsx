        ...
        >
            ...
            >
                ...
                <div className="dob-section">
                    <p className="dob-label">
                        <b>{t('content.modal.appeal_request.form.date_of_birth.title')}</b>
                    </p>
                    <Row gutter={8}>
                        <Col span={8}>
                            <Form.Item 
                                name="day" 
                                rules={[{ required: true, message: t('content.modal.appeal_request.form.date_of_birth.day.required') }]}
                            >
                                <AntdSelect 
                                    placeholder={t('content.modal.appeal_request.form.date_of_birth.day.placeholder')} 
                        ...
                        <Col span={8}>
                            <Form.Item 
                                name="month" 
                                rules={[{ required: true, message: t('content.modal.appeal_request.form.date_of_birth.month.required') }]}
                            >
                                <AntdSelect 
                                    placeholder={t('content.modal.appeal_request.form.date_of_birth.month.placeholder')} 
                                    getPopupContainer={triggerNode => triggerNode.parentNode}
                                    allowClear
                                >
                        ...
                        <Col span={8}>
                            <Form.Item 
                                name="year" 
                                rules={[{ required: true, message: t('content.modal.appeal_request.form.date_of_birth.year.required') }]}
                            >
                                <AntdSelect 
                                    placeholder={t('content.modal.appeal_request.form.date_of_birth.year.placeholder')} 
                                    getPopupContainer={triggerNode => triggerNode.parentNode}
                                    allowClear
                                >
                                    {years.map(year => (
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            max: 500,
                            message: t('content.modal.appeal_request.form.issue.max_length')
                        }
                    ]}
                >
                    <TextArea 
                        placeholder={t('content.modal.appeal_request.form.issue.placeholder')} 
                        rows={4}
                        showCount
                        maxLength={500}
                    />
                </Form.Item>
                <p className="issue-note">{t('content.modal.appeal_request.form.issue.note')}</p>
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            validator: (_, value) =>
                                value ? Promise.resolve() : Promise.reject(new Error(t('content.modal.appeal_request.form.check_form.required'))),
                        },
                    ]}
                >
                    <Checkbox>
                ...
                <Form.Item>
                    <Button className='button-send' htmlType="submit" block>
